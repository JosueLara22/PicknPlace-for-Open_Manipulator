...
*
* Authors of the original teleop application: Darby Lim, Hye-Jong KIM, Ryan Shim,  * Yong-Ho Na
* Authors of the pick and place application: Josue Lara, Sarah Vazquez, Aldo       * Cordova
*******************************************************************************/

#ifndef OPEN_MANIPULATOR_PICKNPLACE_H_
#define OPEN_MANIPULATOR_PICKNPLACE_H__
...
class OpenManipulatorPicknPlace
{
 public:
  OpenManipulatorPicknPlace();
  ~OpenManipulatorPicknPlace();
...
#endif //OPEN_MANIPULATOR_PICKNPLACE_H_
